...
@property (nonatomic,retain) ObjectContext *m_objectContext;
@property (nonatomic,retain) QueryOperationResponse *m_queryResponseObject;
@property (nonatomic,retain) NSMutableDictionary *m_nextLinkUrl;
...
-(void)storeClassProperties:(id)dynamicObject xmlelement:(ODataXMLElements *)theElement;
